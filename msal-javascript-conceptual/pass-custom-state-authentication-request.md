---
title: Pass custom state in authentication requests
...
To learn more, read about [building a single-page application (SPA)](/azure/active-directory/develop/scenario-spa-overview.md) using MSAL.js.
