...
If you are migrating from `@azure/msal-angular` v1, please refer to the [v1-v2 migration guide](v1-v2-upgrade-guide.md) first to migrate to MSAL v2.
...
See the [guide to redirects](redirects.md) for set up details.
